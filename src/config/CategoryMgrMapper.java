...
public interface CategoryMgrMapper {	
	...
	@Insert("INSERT INTO Category (code1, code2, code3, category_name, category_subject, category_use)"
			+ "VALUES (#{code1}, #{code2}, #{code3}, #{categoryName,jdbcType=VARCHAR}, #{categorySubject,jdbcType=VARCHAR}, #{categoryUse})")
