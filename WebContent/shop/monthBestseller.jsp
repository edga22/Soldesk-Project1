...
<div class="container"> 
    ...
    <ul class="list-group">
      ...
      <%
 	  ...
 	  <li class="list-group-item"> 
 	  <div class="row">
 	  	<div class="col-md-1"><input name="bookIdList" type="checkbox" checked="checked" value="<%=bookIdInt%>"/> <%=j %>.</div>
 	  	...
 	  	<div class="col-md-7">
			...
			<i class="glyphicon glyphicon-new-window" style="font-size:1.5rem;color:#555;margin-left:1rem"></i></a><br>
 	  		...
 	  		<p>가격: <%=nf.format(bestseller[i].getBook().getPrice()) %> ￦</p>
 	  	</div>
 	  	<div class="col-md-2">
    ...
    <ul class="list-group">
      ...
      <% 
 	  ...
 	  <li class="list-group-item"> 
 	  <div class="row">
 	  	<div class="col-md-1"><input name="bookIdList2" type="checkbox" checked="checked" value="<%=bookIdInt%>"/> <%=k %>.</div>
 	  	<div class="col-md-2"><img id="img" src="<%=bestseller[i].getBook().getImageID()%>" style="width:85px;height:auto;"/></div>
 	  	<div class="col-md-7">
 	  		<a href="<%=bookIdLink %>" title="<%=bookNamestr %> 바로가기"><%=bookNamestr %></a>
			<a href="<%=bookIdLink %>" title="<%=bookNamestr %> 새창으로보기" target="_blank">
